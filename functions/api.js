...
// This function is mapped to the `/api` route because of its filename `api.js`.
// It will only handle requests made to yourdomain.pages.dev/api.
...
// Main handler for requests to /api
export async function onRequest(context) {
  ...
  // Although the routing handles this, it's good practice to check.
